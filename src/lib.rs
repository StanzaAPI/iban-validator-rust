//! Official Rust Client for Global IBAN, BIC/SWIFT & Bank Routing Validator API
...
#[derive(Debug, Clone)]
pub struct IbanValidatorClient {
...
impl IbanValidatorClient {
    pub fn new(api_key: Option<String>, base_url: Option<String>) -> Self {
        let key = api_key
            .or_else(|| env::var("STANZA_API_KEY").ok())
            .or_else(|| env::var("API_KEY").ok())
            .unwrap_or_default();
        let base = base_url.unwrap_or_else(|| "https://api.stanzaapi.com/iban-validator".to_string());
        ...
        Self {
            ...
            tool_url: "https://stanzaapi.com/tools/iban-validator",
        }
    }
